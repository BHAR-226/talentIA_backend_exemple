...
class PermissionChecker:
    ...
    def can(self, resource: str, action: str, resource_id: Optional[uuid.UUID] = None) -> bool:
        """
    ...
    def check(self, resource: str, action: str, resource_id: Optional[uuid.UUID] = None) -> bool:
        """
...
def _find_user_in_args(args: tuple, kwargs: dict) -> Optional[Utilisateur]:
