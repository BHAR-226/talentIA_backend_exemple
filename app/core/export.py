...
def export_candidatures_to_csv(
    ...
    output_with_bom.write('\ufeff'.encode('utf-8'))
...
def _truncate_text(text: Optional[str], max_length: int = 100) -> str:
...
def export_candidatures(
    offre_id: Optional[str] = Query(None, description="Filtrer par ID d'offre"),
