...
from app.core.enums import StatutOffre, StatutCandidature, TypeContrat
...
class Offre(UUIDMixin, TimestampMixin, SoftDeleteMixin, Base):
    ...
    createur_id: Mapped[Optional[uuid.UUID]] = mapped_column(
        UUID(as_uuid=True),
    ...
    tele_travail: Mapped[Optional[str]] = mapped_column(
        String(50),
        nullable=True,
    ...
    @property
    def fourchette_salaire(self) -> Optional[str]:
