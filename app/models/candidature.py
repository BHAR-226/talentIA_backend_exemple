...
class Candidature(UUIDMixin, TimestampMixin, SoftDeleteMixin, Base):
    ...
    lettre_motivation: Mapped[str | None] = mapped_column(
        Text,
        nullable=True,
    ...
    evaluation_ia: Mapped[dict[str, Any] | None] = mapped_column(
        JSONB,
        nullable=True,
    ...
    date_analyse: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True),
        nullable=True,
        comment="Date d'analyse de la candidature"
    )

    commentaires: Mapped[str | None] = mapped_column(
        Text,
        nullable=True,
        comment="Commentaires généraux sur la candidature"
    )

    evaluation_technique: Mapped[dict[str, Any] | None] = mapped_column(
        JSONB,
        nullable=True,
        comment="Évaluation technique du candidat"
    )

    entretien_notes: Mapped[dict[str, Any] | None] = mapped_column(
        JSONB,
        nullable=True,
    ...
    @property
    def temps_analyse(self) -> int | None:
